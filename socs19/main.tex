...
%% Our macros
\newcommand{\vb}[1]{{\small\sf \color{blue} Vadim: #1}}
\newcommand{\ch}[1]{{\small\sf \color{red} Carlos: #1}}
\newcommand{\sk}[1]{{\small\sf \color{orange} Sven: #1}}
\newcommand{\wy}[1]{{\small\sf \color{cyan} Will: #1}}
\newcommand{\jb}[1]{{\small\sf \color{magenta} Jorge: #1}}
